...
<figure class="app-shot" markdown>
  ![Calculator arranged vertically on a narrow mobile screen](assets/screenshots/calculator-mobile.png)
...
<figure class="app-shot" markdown>
  ![Calculator displaying the result 20 for 12 plus 8](assets/screenshots/addition-result.png)
