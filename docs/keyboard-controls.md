...
<figure class="app-shot" markdown>
  ![Calculator keypad used by the supported keyboard controls](assets/screenshots/calculator-only.png)
  <figcaption>Keyboard input controls the same numbers and operations shown on the calculator keypad.</figcaption>
</figure>
